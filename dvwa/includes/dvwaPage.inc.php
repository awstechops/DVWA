...
function dvwaHtmlEcho( $pPage ) {
	...
	if( dvwaIsLoggedIn() ) {
		$menuBlocks[ 'meta' ][] = array( 'id' => 'security', 'name' => 'Banking Security', 'url' => 'security.php' );
...
<html lang=\"en-GB\">
	...
	<body class=\"home\">
		<div id=\"container\">
			...
			<br />
			<div class=\"topnav\">
			<img src=\"" . DVWA_WEB_PAGE_TO_ROOT . "dvwa/images/TBLogo.png\" width=\"70\" height=\"70\" style=\"float:none\"/>
